...
- https://github.com/adam-cyclones/ForgeRock-JS-SDK-walkthrough/commit/e092af8 step.3.1 After a successful login, use the SDK's getTokens to call an OAuth client to get access token and id token
